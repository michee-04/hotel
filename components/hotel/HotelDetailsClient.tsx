    ...
    <div className="flex flex-col gap-6 pb-2">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 content-start text-sm">
          ...
          {hotel.shoping && <AmenityItem><ShoppingBasket className="w-4 h-4" />Shopping</AmenityItem>}
          {hotel.freeParking && <AmenityItem><Car className="w-4 h-4" />Shopping</AmenityItem>}
          {hotel.movieNight && <AmenityItem><Clapperboard className="w-4 h-4" />Shopping</AmenityItem>}
